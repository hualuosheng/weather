...
<script>
import goodList from '@/components/library/good-list/good-list'
import MescrollMixin from '@/components/library/mescroll-uni/mescroll-mixins.js'
import MescrollMoreItemMixin from '@/components/library/mescroll-uni/mixins/mescroll-more-item.js'
