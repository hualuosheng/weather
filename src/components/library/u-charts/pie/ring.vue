...
<script>
import uCharts from '@/components/library/u-charts/u-charts.js'
import { isJSON } from '@/common/canvas/checker.js'
var _self
var canvaRing = null
...
export default {
  ...
  methods: {
    getServerData() {
      ...
      Ring.series = this.data.Ring.series
      //自定义文案示例，需设置format字段
      ...
      _self.textarea = JSON.stringify(this.data.Ring.series)
